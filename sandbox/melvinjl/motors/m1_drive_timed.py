...
#     600 degrees / second  -->  traveled 34.2 inches  -->  6.84 inches / second
#     700 degrees / second  -->  traveled 39 inches  -->  7.8 inches / second
#     800 degrees / second  -->  traveled 44.75 inches  -->  8.95 inches / second
#     900 degrees / second  -->  traveled 48.5 inches  -->  9.7 inches / second (probably no faster than 800)
#
...
#
#       speed_in_inches_per_second = .01064 * speed_in_degrees_per_second + 0
#       LoggerPro used to find m
#
...
def main():
    ...
    print("Goodbye")
    ev3.Sound.speak("Waffle Iron").wait()
